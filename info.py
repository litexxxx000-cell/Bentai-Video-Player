...
# Bot Session Name
SESSION = environ.get('SESSION', 'BentaiBot')

# Your Telegram Account Api Id And Api Hash
API_ID = int(environ.get('API_ID', '36877233'))
API_HASH = environ.get('API_HASH', '79f1a8128c6c41001d946a185c051ddf')

# Bot Token, This Is Main Bot
BOT_TOKEN = environ.get('BOT_TOKEN', "")

# Admin Telegram Account Id For Withdraw Notification Or Anything Else
ADMIN = int(environ.get('ADMIN', '7009144658'))
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003711205797'))
...
LINK_URL = environ.get("LINK_URL", "https://bentaidubbers.blogspot.com/p/g.html")
